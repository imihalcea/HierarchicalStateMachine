...
public class StateDsl<TState, TInput, TOutput> where TState:notnull
{
    ...
    {
        var initialState = _stateMachineDsl.DefinedStates.First(s => s.Id.Equals(_stateMachineDsl.InitialStateId));
        return new StateMachineDef<TState, TInput, TOutput>(initialState, _stateMachineDsl.DefinedStates);
    }
